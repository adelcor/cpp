...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/23 12:30:15 by adel-cor          #+#    #+#             */
/*   Updated: 2022/11/23 12:30:34 by adel-cor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		std::cout << "\033[31mClapTrap " << this->_name << " is not able to repair itself, beacuse he doesn't have enough hit points.\033[0m" << std::endl;
	}
	else
