...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/01 10:23:27 by adel-cor          #+#    #+#             */
/*   Updated: 2022/12/01 13:20:26 by adel-cor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	PresidentialPardonForm::execute(Bureaucrat const &executor)const
{
	...
	{
		std::cerr << this->getName() << " Form cannot *TEeeeeeeeeeeeeeeST* be executed by " << executor.getName() << " because " << e.what() << std::endl;
	}
}
